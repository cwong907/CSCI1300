    ...
    while(stoi(n) != 6)
    {
        ...
        switch(stoi(n))
        {
            case 1:
                ...
                fr = readBooks(bookFile, books, numBookStored, booksArrSize);
                //cout << fr << endl;
            ...
            case 2:
                ...
                ur = readRatings(userFile, users, numUsersStored, usersArrSize, maxCol);
            ...
            case 3:
                ...
                c = getRating(userName, title, users, books, userNum, booksNum);
